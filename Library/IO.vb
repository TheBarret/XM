...
Namespace Library
    Public Class IO
        ...
        Public Shared Function IsFile(filename As String) As Boolean
            Return File.Exists(filename) AndAlso Not File.GetAttributes(filename) = FileAttributes.Directory
        End Function
        <Method(Types.Null, "isdirectory")>
        Public Shared Function IsDirectory(filename As String) As Boolean
            Return Directory.Exists(filename) AndAlso File.GetAttributes(filename) = FileAttributes.Directory
        End Function
    End Class
End Namespace